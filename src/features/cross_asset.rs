...
impl CrossAssetFeatureGenerator {
    ...
    fn add_cross_features_to_dataframe(
        ...
        if self.config.btc_dominance_enabled {
            df = df
                .with_column(
                    Series::new("cross_btc_dominance".into(), btc_dominance_values).into_column(),
                )
                .map_err(|e| {
        ...
        if self.config.sentiment_analysis.enabled {
            df = df
                .with_column(
                    Series::new("cross_market_sentiment".into(), market_sentiment_values)
                        .into_column(),
                )
                .map_err(|e| {
        ...
        if self.config.eth_btc_ratio_enabled {
            df = df
                .with_column(
                    Series::new("cross_eth_btc_ratio".into(), eth_btc_ratio_values).into_column(),
                )
                .map_err(|e| {
        ...
        df = df
            .with_column(
                Series::new("cross_price_correlation".into(), price_correlation_values)
                    .into_column(),
            )
            .map_err(|e| {
        ...
        df = df
            .with_column(
                Series::new("cross_market_momentum".into(), market_momentum_values).into_column(),
            )
            .map_err(|e| {
