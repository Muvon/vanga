...
pub async fn generate_volatility_features(
    ...
    df = df
        .with_column(Series::new("realized_volatility".into(), realized_vol))
        .map_err(|e| {
        ...
        .clone();
    df = df
        .with_column(Series::new("range_volatility".into(), range_vol))
        .map_err(|e| {
            crate::utils::error::VangaError::DataError(format!(
        ...
        .clone();
    df = df
        .with_column(Series::new("volatility_of_volatility".into(), vol_of_vol))
        .map_err(|e| {
            crate::utils::error::VangaError::DataError(format!(
        ...
        .clone();
    df = df
        .with_column(Series::new("garch_volatility".into(), garch_vol))
        .map_err(|e| {
            crate::utils::error::VangaError::DataError(format!(
