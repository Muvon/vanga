...
fn add_sma_indicators(
    ...
    for (column_name, sma_values) in sma_results {
        let series = Series::new(column_name.clone().into(), sma_values);
        df = df
            .with_column(series)
            .map_err(|e| {
...
fn add_ema_indicators(
    ...
    for (column_name, ema_values) in ema_results {
        let series = Series::new(column_name.clone().into(), ema_values);
        df = df
            .with_column(series)
            .map_err(|e| {
                VangaError::FeatureError(format!("Failed to add {} column: {}", column_name, e))
...
fn add_macd_indicators(
    ...
    df = df
        .with_column(Series::new("macd".into(), macd_line))
        .map_err(|e| VangaError::FeatureError(format!("Failed to add MACD column: {}", e)))?
        .clone();

    df = df
        .with_column(Series::new("macd_signal".into(), signal_line))
        .map_err(|e| VangaError::FeatureError(format!("Failed to add MACD signal column: {}", e)))?
        .clone();

    df = df
        .with_column(Series::new("macd_histogram".into(), histogram))
        .map_err(|e| {
...
fn add_bollinger_bands(
    ...
    df = df
        .with_column(Series::new("bb_upper".into(), upper))
        .map_err(|e| {
    ...
    df = df
        .with_column(Series::new("bb_middle".into(), middle))
        .map_err(|e| {
    ...
    df = df
        .with_column(Series::new("bb_lower".into(), lower))
        .map_err(|e| {
...
fn add_rsi_indicators(
    ...
    for (column_name, rsi_values) in rsi_results {
        let series = Series::new(column_name.clone().into(), rsi_values);
        df = df
            .with_column(series)
            .map_err(|e| {
                VangaError::FeatureError(format!("Failed to add {} column: {}", column_name, e))
...
fn add_stochastic_indicators(
    ...
    df = df
        .with_column(Series::new("stoch_k".into(), k_values))
        .map_err(|e| VangaError::FeatureError(format!("Failed to add Stochastic %K: {}", e)))?
        .clone();

    df = df
        .with_column(Series::new("stoch_d".into(), d_values))
...
fn add_williams_r(
    ...
    df = df
        .with_column(Series::new("williams_r".into(), williams_r_values))
...
fn add_cci_indicator(
    ...
    let series = Series::new(column_name.clone().into(), cci_values);
    df = df
        .with_column(series)
...
fn add_volume_indicators(
    ...
    for &period in periods {
        ...
        let series = Series::new(column_name.clone().into(), volume_sma);
        df = df
            .with_column(series)
            .map_err(|e| VangaError::FeatureError(format!("Failed to add {}: {}", column_name, e)))?
            .clone();
        ...
        let series = Series::new(corr_column_name.clone().into(), pv_correlation);
        df = df
            .with_column(series)
            .map_err(|e| {
        ...
        let series = Series::new(vwap_column_name.clone().into(), vwap);
        df = df
            .with_column(series)
            .map_err(|e| {
...
fn add_obv_indicator(mut df: DataFrame, close: &[f64], volume: &[f64]) -> Result<DataFrame> {
    ...
    df = df
        .with_column(Series::new("obv".into(), obv_values))
...
fn add_mfi_indicator(
    ...
    let series = Series::new(column_name.clone().into(), mfi_values);
    df = df
        .with_column(series)
        .map_err(|e| VangaError::FeatureError(format!("Failed to add {}: {}", column_name, e)))?
        .clone();
...
fn add_atr_indicators(
    ...
    for &period in periods {
        ...
        let series = Series::new(column_name.clone().into(), atr_values);
        df = df
            .with_column(series)
            .map_err(|e| VangaError::FeatureError(format!("Failed to add {}: {}", column_name, e)))?
            .clone();
...
fn add_keltner_channels(
    ...
    df = df
        .with_column(Series::new("keltner_upper".into(), keltner_upper))
        .map_err(|e| VangaError::FeatureError(format!("Failed to add Keltner upper: {}", e)))?
        .clone();

    df = df
        .with_column(Series::new("keltner_lower".into(), keltner_lower))
...
fn add_crypto_specific_indicators(
    ...
    if advanced_config.enabled {
        ...
        df = df
            .with_column(Series::new("hurst_exponent".into(), hurst_values))
            .map_err(|e| VangaError::FeatureError(format!("Failed to add hurst_exponent: {}", e)))?
            .clone();

        df = df
            .with_column(Series::new("fractal_dimension".into(), fractal_dims))
            .map_err(|e| {
        ...
        df = df
            .with_column(Series::new("regime_indicator".into(), regime_values))
            .map_err(|e| {
