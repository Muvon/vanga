...
mod tests {
    ...
    fn test_market_data_row_creation() {
        let row = MarketDataRow::new(1640995200, 47000.0, 47100.0, 46900.0, 47050.0, 1234.56);

        assert_eq!(row.timestamp, 1640995200);
    ...
    fn test_market_data_validation() {
        let valid_row = MarketDataRow::new(1640995200, 47000.0, 47100.0, 46900.0, 47050.0, 1234.56);
        assert!(valid_row.is_valid());

        let invalid_row =
            MarketDataRow::new(1640995200, 47000.0, 46800.0, 46900.0, 47050.0, 1234.56); // high < low
        assert!(!invalid_row.is_valid());

        let negative_price =
            MarketDataRow::new(1640995200, -47000.0, 47100.0, 46900.0, 47050.0, 1234.56);
    ...
    fn test_extended_market_data() {
        let base = MarketDataRow::new(1640995200, 47000.0, 47100.0, 46900.0, 47050.0, 1234.56);
