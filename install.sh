...
EXAMPLES WITH ENVIRONMENT VARIABLES:
    ...
    curl -fsSL https://raw.githubusercontent.com/Muvon/vanga/master/install.sh | sh
    curl -fsSL https://raw.githubusercontent.com/Muvon/vanga/master/install.sh | sh -s -- --version 0.1.0
